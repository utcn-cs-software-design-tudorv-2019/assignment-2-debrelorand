...
public class NewAccountView extends JFrame {
	...
	public NewAccountView() {
		...
		textField_Username = new JTextField("debre");
		...
		textField_Password = new JPasswordField("123456");
		...
		textField_Nume = new JTextField("Debre");
		...
		textField_Prenume = new JTextField("Lorand");
		...
		textField_Adresa = new JTextField("Cluj Napoca, nr.112");
		...
		textField_CNP = new JTextField("1970317123456");
		...
		textField_Email = new JTextField("debre.lorand@yahoo.com");
		...
		//System.out.println(studentBLL.getByID(1));
		/*
		...
		*/
		...
		textField_Grupa = new JTextField("30233");
